...
const amenitySections: AmenitySection[] = [
  ...
  },
  {
    title: "Bathrooms",
    description:
      "Restrooms are available for brothers and sisters and are cleaned regularly throughout the day. We kindly ask everyone to help keep the facilities clean and dry for the next person by using the bins provided and reporting any supply needs.",
  },
  {
    title: "Wudu Area",
    description:
...
//comment for deployment
  return (
    <div className="min-h-screen bg-stone-50 text-stone-900 dark:bg-stone-950 dark:text-stone-100">
        ...
        <div className="grid gap-6 md:grid-cols-3">
          {amenitySections.map((section) => (
            <Card key={section.title} className="overflow-hidden rounded-[30px] border-stone-200 shadow-sm dark:border-stone-800 dark:bg-stone-900/70">
              <CardContent className="p-0">
                <div className="flex min-h-[180px] items-center justify-center border-b border-stone-200 bg-stone-100 dark:border-stone-800 dark:bg-stone-900/70">
                  <div className="mx-6 flex h-[120px] w-full max-w-[220px] items-center justify-center rounded-2xl border-2 border-dashed border-stone-300 bg-white text-center text-sm font-medium text-stone-500 dark:border-stone-600 dark:bg-stone-950 dark:text-stone-300">
                    Picture Placeholder
                  </div>
                </div>
                <div className="p-6">
      ...
      <motion.section {...revealInView} className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        <Card className="rounded-[32px] border-stone-200 shadow-sm">
          <CardContent className="p-8 lg:p-10">
            ...
            <h3 className="mt-3 text-3xl font-bold">Learn about Masjid leadership</h3>
            <div className="mt-6">
              <Button asChild className="rounded-2xl bg-emerald-700 hover:bg-emerald-800">
                <Link href="/about/leadership">Visit Leadership Page</Link>
              </Button>
            </div>
          </CardContent>
        </Card>
